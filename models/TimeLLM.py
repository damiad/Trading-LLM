...
class Model(nn.Module):
    ...
    def __init__(self, configs, patch_len=16, stride=8):
        ...
        self.llama_config = LlamaConfig.from_pretrained('/home/heorhii/zpp/Time-LLM/llama-7b')
        ...
        self.llama = LlamaModel.from_pretrained(
            ...
            "/home/heorhii/zpp/Time-LLM/llama-7b",
            # 'huggyllama/llama-7b',
        ...
        self.tokenizer = LlamaTokenizer.from_pretrained(
            ...
            "/home/heorhii/zpp/Time-LLM/llama-7b/tokenizer.model",
            # 'huggyllama/llama-7b',
            trust_remote_code=True,
            local_files_only=True
        )
