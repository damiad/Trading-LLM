...
class Dataset_GBPCAD_hour(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='gbpcad_one_hour_202311210827.csv',
    ...
    def __read_data__(self):
        ...
        df_raw = pd.read_csv(os.path.join(self.root_path,
                                          self.data_path))
        df_raw.rename(columns={'barTimestamp': 'date'}, inplace=True)
        df_raw.drop(['id', 'provider', 'dayOfWeek', "insertTimestamp"], axis=1, inplace=True)
